...
def build_attrs(
    ...
    if entry.supports_product:
        ...
        if product and hasattr(attrs_module, "Physobs"):
            try:
                from app.services.solar.jsoc_client import hmi_physobs
...
def fetch_via_jsoc(
    ...
    *,
    ...
    session cache.
    """
    from app.services.solar.download_manager import DownloadItem, DownloadManager
    from app.services.solar.jsoc_client import export_urls
