...
def render_spectrum_png(
    ...
    vmin/vmax default to the e-CALLISTO display range.
    """
    out_path.parent.mkdir(parents=True, exist_ok=True)

    # Taller, higher-resolution figure so the spectrum reads well in a panel.
    ...
    ax.set_xlabel("Time (s from start, UT)", color="#94a3b8", fontsize=10)
